...
public class MergeCommand extends BaseCommand {
  ...
  @Option(
      ...
      defaultValue = "append")
  private MergeStrategy strategy = MergeStrategy.append;
      ...
      output.write(
          ...
          """
              .formatted(
                  data.get("strategy"),
                  data.get("outputFile"),
                  ((Number) stats.get("locations")).intValue(),
                  ((Number) stats.get("sessions")).intValue(),
                  ((Number) stats.get("climbs")).intValue()));
    }
  }
