...
class ValidateCommandSimpleSpec extends Specification {
    ...
    private void createValidCLDF(File file) {
        def archive = app.crushlog.cldf.api.CLDFArchive.builder()
            .manifest(app.crushlog.cldf.models.Manifest.builder()
                .version("1.0.0")
                .format("CLDF")
                .creationDate(java.time.OffsetDateTime.now())
                .appVersion("1.0.0")
                .platform(app.crushlog.cldf.models.enums.Platform.ANDROID)
                .build())
            .locations([
                app.crushlog.cldf.models.Location.builder()
                    .id(1)
                    .name("Test Location")
                    .isIndoor(false)
                    .coordinates(app.crushlog.cldf.models.Location.Coordinates.builder()
                        .latitude(40.7128d)
                        .longitude(-74.0060d)
                        .build())
                    .build()
            ...
            .sessions([
                app.crushlog.cldf.models.Session.builder()
                    .id(1)
            ...
            .climbs([
                app.crushlog.cldf.models.Climb.builder()
                    .id(1)
                    .sessionId(1)
                    .routeId(1)
                    .date(java.time.LocalDate.now())
                    ...
                    .attempts(1)
                    .type(app.crushlog.cldf.models.enums.ClimbType.BOULDER)
                    .finishType(app.crushlog.cldf.models.enums.FinishType.TOP)
                    .build()
            ])
            .build()
