...
void main() {
  group('CLID (CrushLog ID) Generation', () {
    ...
    test('Generate deterministic route CLID for The Nose', () {
      ...
      expect(routeCLID, equals(routeCLID2), 
    ...
    test('Generate sector CLID', () {
      ...
      final sectorCLID = CLIDGenerator.generateSectorCLID(locationCLID, dawnWall);
    ...
    test('Generate random CLID for climb', () {
      ...
      expect(climbCLID1, isNot(equals(climbCLID2)), 
    ...
    test('Validate invalid CLID format', () {
      ...
      expect(() => CLIDGenerator.parse('invalid-id'), 
          throwsArgumentError);
    });
    ...
    test('Validation errors for invalid location', () {
      ...
      expect(() => CLIDGenerator.generateLocationCLID(invalidLocation),
          throwsArgumentError);
    });
